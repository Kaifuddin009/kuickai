...
const Testimonial = () => {
        ...
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
           ...
           {/* <div className='flex flex-wrap mt-10 justify-center'>
                {dummyTestimonialData.map((testimonial, index)=>(
                                <div key={index} className="p-8 mb-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transiotion duration cursor-pointer">
    ...
    {dummyTestimonialData.map((testimonial, index) => (
        <div 
            key={index} 
            className="p-8 mb-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration cursor-pointer"
        >
            <div className="flex items-center gap-1">
